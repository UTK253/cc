...
export default function ResourcesPage() {
    ...
    const handleResourceClick = (resource: Resource) => {
        // Always show the content in a modal for smoother experience, 
        // especially for videos which we now embed.
    ...
    return (
        <div className="min-h-screen bg-muted/5 py-12">
            ...
            {selectedResource && (
                ...
                >
                    <div
                        className="bg-background rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden flex flex-col"
