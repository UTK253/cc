...
import {
    Calendar, Clock, CheckCircle2, Video, MessageCircle, User,
    LogOut, ArrowRight, PlayCircle
} from "lucide-react";
...
export default function CounselorDashboard() {
    ...
    const fetchData = useCallback(() => {
        ...
        const data = db.getCounselorData(currentUser.id);
        if (data && data.counselor) {
    ...
    const handleLogout = () => {
        ...
        router.push("/login"); // Updated to point to main login
    };

    const handleCompleteSession = (id: string) => {
        db.updateAppointmentStatus(id, "Completed");
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="pt-4 space-y-2">
                                            {selectedSession.status === "Upcoming" && (
                                                <Button className="w-full gap-2" onClick={() => handleCompleteSession(selectedSession.id)}>
